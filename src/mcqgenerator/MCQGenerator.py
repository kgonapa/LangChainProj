...
#importing necessary packagess from langchain
...
#Access the envitronment variables from the .env file
key=os.getenv("OPENAI_API_KEY")

llm=ChatOpenAI(openai_abi_key=key, model_name="gpt-3.5-turbo", temparature=0.7)
